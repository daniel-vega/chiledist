...
----------
    # ReCom
    from chiledist.engines.samplers.recom import run_recom, analyze_ensemble
    planes = run_recom(gdf, id_col="ID_DIST", pop_col="personas",
                       n_districts=8, n_steps=10_000)

    # Multi-cadena con diagnósticos
    from chiledist.engines.samplers.diagnostics import run_multiple_chains, mixing_diagnostics
